...
public class UsuarioPeliculaDTO {
	...
	public UsuarioPeliculaDTO(int idUsuarioPelicula, LocalDateTime fechaVisualizacion, int idPelicula, int idUsuario) {
	...
	public UsuarioPeliculaDTO(LocalDateTime fechaVisualizacion, int idPelicula, int idUsuario) {
		super();
		this.fechaVisualizacion = fechaVisualizacion;
		this.idPelicula = idPelicula;
		this.idUsuario = idUsuario;
